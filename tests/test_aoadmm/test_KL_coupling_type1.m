% Test coupling type 1 (H*C = Delta) with KL divergence loss.
%
% Same coupling geometry as test_script_coupling_type1 but with KL loss.
% Expected to fail until ADMM_coupled_case1 lbfgsb_update call is fixed.

function tests = test_KL_coupling_type1
