...
%% create data
[X, Atrue, Deltatrue,sigmatrue] = cmtf.utils.create_CP_data_example10piecewiseconstant('model', model, 'size', sz, 'modes', modes, 'lambdas', lambdas_data, 'noise', noise,'coupling',coupling,'normalize_columns',normalize_columns,'distr_data',distr_data,'loss_function',Z.loss_function); %create data
